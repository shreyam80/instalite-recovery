...
--
-- Host: 127.0.0.1    Database: instagram_clone_db_1
-- ------------------------------------------------------
...
CREATE TABLE `chat_messages` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `chat_messages_ibfk_1` FOREIGN KEY (`chat_session_id`) REFERENCES `chat_sessions` (`chat_session_id`),
...
CREATE TABLE `friends` (
  ...
  CONSTRAINT `friends_ibfk_1` FOREIGN KEY (`follower`) REFERENCES `users` (`user_id`),
  CONSTRAINT `friends_ibfk_2` FOREIGN KEY (`following`) REFERENCES `users` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `posts` (
  ...
  `external_site_id` varchar(255) DEFAULT NULL,
...
CREATE TABLE `user_hashtags` (
  ...
  CONSTRAINT `user_hashtags_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `linked_actor_id` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2025-04-15 21:03:08
